...
use types::pbft::consensus::{Block, BlockId, PeerId, PeerInfo};
use common_trait::pbft::service::Service;
use crate::protos::consensus::ConsensusPeerMessageHeader;
...
mod tests {
    ...
    use crypto::secp256k1::secp256k1::Secp256k1PrivateKey;
    use sawtooth_sdk::consensus::engine::{Error, PeerId, PeerMessage, Update};
    use sawtooth_sdk::signing::secp256k1::Secp256k1PrivateKey;
    use serde_json;
    use types::pbft::consensus::Error;
