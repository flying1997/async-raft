...
//! This crates provides an API for logging in rl.
...
//! see the [coding guidelines](https://developers.rl.com/docs/core/coding-guidelines#logging).
//!
...
//!
//! ```
//! use rl_logger::{info, sample, sample::{SampleRate, Sampling}};
...
pub use crate::rl_logger::{
    Rlogger, Rlogger as Logger, RloggerBuilder, Writer, CHANNEL_SIZE,
};
pub use event::Event;
