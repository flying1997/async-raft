// Copyright (c) The rl Core Contributors
...
/// A builder for a `Rlogger`, configures what, where, and how to write logs.
pub struct RloggerBuilder {
    channel_size: usize,
    level: Level,
    remote_level: Level,
...
impl RloggerBuilder {
    ...
    pub fn build(&mut self) -> Arc<Rlogger> {
        let filter = {
            let local_filter = {
...
pub struct Rlogger {
    ...
    printer: Option<Box<dyn Writer>>,
    filter: RwLock<RlFilter>,
    pub(crate) formatter: fn(&LogEntry) -> Result<String, fmt::Error>,
}

impl Rlogger {
    pub fn builder() -> RloggerBuilder {
        RloggerBuilder::new()
    }

    #[allow(clippy::new_ret_no_self)]
    pub fn new() -> RloggerBuilder {
        Self::builder()
    }
...
/// or to a `Rlogger` for external logging.
...
/// Example:
/// 2020-03-07 05:03:03 INFO [thread_name] common/rl-logger/src/lib.rs:261 Hello { "world": true }
